...
@Tag("spec") class Chapter9Test {
    ...
    @Test fun spec_9_3_Bare_Documents() {
        parseAndCheck("" +
            "Bare\n" +
            "document\n" +
            "...\n" +
    ...
    @Disabled @Test fun spec_9_4_Explicit_Documents() {
        parseAndCheck("" +
            "---\n" +
            // "{ matches\n" +
            // "% : 20 }\n" + // TODO map!!
    ...
    @Disabled @Test fun spec_9_5_Directives_Documents() {
        parseAndCheck("" +
            "%YAML 1.2\n" +
            "---\n" + // TODO '|'
    ...
    @Disabled @Test fun spec_9_6_Stream() {
        parseAndCheck("" +
            "Document\n" +
            "---\n" +
            "# Empty\n" +
