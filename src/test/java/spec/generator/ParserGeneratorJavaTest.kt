...
class ParserGeneratorJavaTest {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateSimpleLiteralProduction() {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateLiteralProductionWithOneArg() {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateLiteralProductionWithLessArg() {
        val written = generate(Production(0, "foo", "<n",
            LiteralExpression("bar")))
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateLiteralProductionWithLessEqArg() {
        val written = generate(Production(0, "foo", "≤n",
            LiteralExpression("bar")))
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateLiteralProductionWithTwoArgs() {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateLiteralProductionWithMinus() {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateLiteralProductionWithPlus() {
        val written = generate(Production(0, "c+foo", null,
            LiteralExpression("bar")))
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateRefProduction() {
        val written = generate(Production(0, "foo", null,
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateAlternativeReferencesProduction() {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateAlternativeCodePointsProduction() {
    ...
    @Test @Throws(IOException::class)
    fun shouldGenerateMixedAlternativesProduction() {
    ...
    @Test
    @Throws(IOException::class)
    fun shouldGenerateMinusRefProduction() {
