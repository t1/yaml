...
@Tag("spec") class Chapter2Test {
    ...
    @Test void spec_2_7_Two_Documents_in_a_Stream() {
        parseAndCheck("" +
    ...
    @Test void spec_2_10_Node_for_Sammy_Sosa_appears_twice_in_this_document() {
        parseAndCheck("" +
                        "---\n" +
                        "hr:\n" +
                        "  - Mark McGwire\n" +
    ...
    @Test void spec_2_12_Compact_Nested_Mapping() {
        parseAndCheck("" +
                        "---\n" +
                        "# Products purchased\n" +
                        "- item    : Super Hoop\n" +
