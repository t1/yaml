...
@Tag("spec") class Chapter2Test {
    ...
    @Test void spec_2_4_Sequence_of_Mappings() {
        parseAndCheck("" +
                "-\n" +
                "  name: Mark McGwire\n" +
                "  hr:   65\n" +
    ...
    @Test void spec_2_5_Sequence_of_Sequences() {
        parseAndCheck("" +
                "- [name        , hr, avg  ]\n" +
    ...
    // TODO flow mapping
    @Disabled @Test void spec_2_6_Mapping_of_Mappings() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_7_Two_Documents_in_a_Stream() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_9_Single_Document_with_Two_Comments() {
        parseAndCheck("" +
                "---\n" +
                "hr: # 1998 hr ranking\n" +
                "  - Mark McGwire\n" +
    ...
    @Disabled @Test void spec_2_10_Node_for_Sammy_Sosa_appears_twice_in_this_document() {
        parseAndCheck("" +
                "---\n" +
                "hr:\n" +
                "  - Mark McGwire\n" +
    ...
    @Disabled @Test void spec_2_11_Mapping_between_Sequences() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_12_Compact_Nested_Mapping() {
        parseAndCheck("" +
                "---\n" +
                "# Products purchased\n" +
                "- item    : Super Hoop\n" +
    ...
    // TODO literal scalar
    @Disabled @Test void spec_2_13_In_literals_newlines_are_preserved() {
        parseAndCheck("" +
                "# ASCII Art\n" +
                "--- |\n" +
                "  \\//||\\/||\n" +
    ...
    // TODO folded scalar
    @Disabled @Test void spec_2_14_In_the_folded_scalars_newlines_become_spaces() {
        parseAndCheck("" +
                "--- >\n" +
                "  Mark McGwire's\n" +
                "  year was crippled\n" +
    ...
    // TODO folded scalar
    @Disabled @Test void spec_2_15_Folded_newlines_are_preserved_for_more_indented_and_blank_lines() {
        parseAndCheck("" +
                ">\n" +
    ...
    @Disabled @Test void spec_2_16_Indentation_determines_scope() {
        parseAndCheck("" +
                "name: Mark McGwire\n" +
                "accomplishment: >\n" +
    ...
    @Disabled @Test void spec_2_17_Quoted_Scalars() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_18_Multi_line_Flow_Scalars() {
        parseAndCheck("" +
                "plain:\n" +
    ...
    @Test void spec_2_20_Floating_Point() {
        parseAndCheck("" +
    ...
    @Test void spec_2_21_Miscellaneous() {
        parseAndCheck("" +
    ...
    @Test void spec_2_22_Timestamps() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_23_Various_Explicit_Tags() {
        parseAndCheck("" +
                "---\n" +
    ...
    @Disabled @Test void spec_2_24_Global_Tags() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_25_Unordered_Sets() {
        parseAndCheck("" +
    ...
    // TODO recognize explicit tags && document right after directives-end
    @Disabled @Test void spec_2_26_Ordered_Mappings() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_27_Invoice() {
        parseAndCheck("" +
    ...
    @Disabled @Test void spec_2_28_Log_File() {
        parseAndCheck("" +
                "---\n" +
